Este é um desafio tanto de desenvolvimento de software quanto de engenharia de software. Onde é testada a capacidade de construir um software com várias partes diferentes funcionando em conjunto!
...
Neste desafio deve-se criar uma API REST no GitHub ou GitLab. Leia com atenção todas as instruções a seguir!
